...
export const KeyValueAppend = {
  encode(message: KeyValueAppend, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.entry !== undefined) {
      KeyValue.encode(message.entry, writer.uint32(10).fork()).ldelim();
    }
    if (message.action !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): KeyValueAppend {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const KeyValueMutation = {
  encode(message: KeyValueMutation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.append !== undefined) {
      KeyValueAppend.encode(message.append, writer.uint32(10).fork()).ldelim();
    }
    if (message.remove !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): KeyValueMutation {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataSource = {
  encode(message: DataSource, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.watched_directory !== undefined) {
      WatchedDirectory.encode(message.watched_directory, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
...
export const RetryPolicy = {
  encode(message: RetryPolicy, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.retry_priority !== undefined) {
      RetryPolicy_RetryPriority.encode(message.retry_priority, writer.uint32(34).fork()).ldelim();
    }
    for (const v of message.retry_host_predicate) {
      RetryPolicy_RetryHostPredicate.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.host_selection_retry_max_attempts = longToNumber(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const RetryPolicy_RetryPriority = {
  encode(message: RetryPolicy_RetryPriority, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RetryPolicy_RetryPriority {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RetryPolicy_RetryHostPredicate = {
  encode(message: RetryPolicy_RetryHostPredicate, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.typed_config !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RetryPolicy_RetryHostPredicate {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
