...
export const DeniedHttpResponse: MessageFns<DeniedHttpResponse> = {
...
export const OkHttpResponse: MessageFns<OkHttpResponse> = {
...
export const CheckResponse: MessageFns<CheckResponse> = {
  encode(message: CheckResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.denied_response !== undefined) {
      DeniedHttpResponse.encode(message.denied_response, writer.uint32(18).fork()).join();
    }
    if (message.ok_response !== undefined) {
      OkHttpResponse.encode(message.ok_response, writer.uint32(26).fork()).join();
    }
    if (message.dynamic_metadata !== undefined) {
