...
export const TcpKeepalive: MessageFns<TcpKeepalive> = {
  encode(message: TcpKeepalive, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.keepalive_probes !== undefined) {
      UInt32Value.encode({ value: message.keepalive_probes! }, writer.uint32(10).fork()).join();
    }
    if (message.keepalive_time !== undefined) {
      UInt32Value.encode({ value: message.keepalive_time! }, writer.uint32(18).fork()).join();
    }
    if (message.keepalive_interval !== undefined) {
      UInt32Value.encode({ value: message.keepalive_interval! }, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const Address: MessageFns<Address> = {
  encode(message: Address, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.socket_address !== undefined) {
      SocketAddress.encode(message.socket_address, writer.uint32(10).fork()).join();
    }
    if (message.pipe !== undefined) {
      Pipe.encode(message.pipe, writer.uint32(18).fork()).join();
    }
    if (message.envoy_internal_address !== undefined) {
      EnvoyInternalAddress.encode(message.envoy_internal_address, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const CidrRange: MessageFns<CidrRange> = {
  encode(message: CidrRange, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.prefix_len !== undefined) {
      UInt32Value.encode({ value: message.prefix_len! }, writer.uint32(18).fork()).join();
    }
    return writer;
  },
