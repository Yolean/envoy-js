...
import { HeaderMap, Metadata } from "../../../config/core/v3/base";
...
export const AttributeContext: MessageFns<AttributeContext> = {
  encode(message: AttributeContext, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.context_extensions).forEach(([key, value]) => {
      AttributeContext_ContextExtensionsEntry.encode({ key: key as any, value }, writer.uint32(82).fork()).join();
    });
    ...
    if (message.route_metadata_context !== undefined) {
      Metadata.encode(message.route_metadata_context, writer.uint32(106).fork()).join();
    }
    if (message.tls_session !== undefined) {
      AttributeContext_TLSSession.encode(message.tls_session, writer.uint32(98).fork()).join();
    }
    return writer;
  },
...
export const AttributeContext_Peer: MessageFns<AttributeContext_Peer> = {
  encode(message: AttributeContext_Peer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      AttributeContext_Peer_LabelsEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
...
export const AttributeContext_HttpRequest: MessageFns<AttributeContext_HttpRequest> = {
  encode(message: AttributeContext_HttpRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.headers).forEach(([key, value]) => {
      AttributeContext_HttpRequest_HeadersEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    if (message.header_map !== undefined) {
      HeaderMap.encode(message.header_map, writer.uint32(106).fork()).join();
    }
    if (message.path !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.header_map = HeaderMap.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): AttributeContext_HttpRequest {
    return {
      ...
      headers: isObject(object.headers)
        ...
        : {},
      header_map: isSet(object.header_map) ? HeaderMap.fromJSON(object.header_map) : undefined,
  ...
  toJSON(message: AttributeContext_HttpRequest): unknown {
    ...
    if (message.header_map !== undefined) {
      obj.header_map = HeaderMap.toJSON(message.header_map);
    }
    if (message.path !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<AttributeContext_HttpRequest>, I>>(object: I): AttributeContext_HttpRequest {
    ...
    message.header_map = (object.header_map !== undefined && object.header_map !== null)
      ? HeaderMap.fromPartial(object.header_map)
      : undefined;
...
export const AttributeContext_HttpRequest_HeadersEntry: MessageFns<AttributeContext_HttpRequest_HeadersEntry> = {
...
export const AttributeContext_TLSSession: MessageFns<AttributeContext_TLSSession> = {
  encode(message: AttributeContext_TLSSession, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sni !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AttributeContext_TLSSession {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AttributeContext_ContextExtensionsEntry: MessageFns<AttributeContext_ContextExtensionsEntry> = {
